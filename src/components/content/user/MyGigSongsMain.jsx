...
import imageCover from "../../../assets/images/card_cover_image.jpg";
const MyGigSongsMain = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3000/api/gigs/${id}`)
      .then((res) => {
        console.log("res", res);
  ...
  const handleDeleteSong = (songID) => {
    axios
      .put(`http://localhost:3000/api/gigs/${id}/delete-song`, {
        songID: songID,
      })
      .then((res) => {
  ...
  return (
    <div className="overflow-x-auto">
      ...
      <p className="mb-8">{gig?.venueType}</p>
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-4">
                        <div className="w-16 h-16 rounded-xl overflow-hidden shadow-md">
                          <img
                            src={song.coverImage ? song.coverImage : imageCover}
                            alt={song.title}
